    ...
    st.markdown(
        ...
        <style>
            [data-testid="stSidebarNav"] {
                background-image: url(https://raw.githubusercontent.com/jiexu2776/boron-main/main/images/website-profile.gif?token=GHSAT0AAAAAACLTWTPTX37H6H5ZTMIKCPDEZL3EEUA);
